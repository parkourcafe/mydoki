...
const M = {
  ...
  en: {
    metaTitle: "Demo — candidate document checklist flow",
    metaDesc:
      "See the product without signing up: employer checklist, candidate upload link, document status and secure sharing.",
    back: "← Home",
    badge: "Demo",
    title: "Take a look inside — no sign-up",
    sub: "This is a sample with made-up data. In a real workspace, only authorized people and link recipients see the documents.",
    familyTitle: "Candidates",
    members: [
      { name: "Ayu", rel: "candidate", docs: 7 },
      { name: "Budi", rel: "new employee", docs: 5 },
      { name: "Maya", rel: "candidate", docs: 4 },
    ],
    docsTitle: "Documents by checklist",
    docsSub: "Everything sorted by role and document type — see what is complete and what is missing.",
    docCardOwner: "Ayu",
    docCardTitle: "KTP / ID document",
    docCardType: "Candidate documents",
    valid: "Uploaded for front-desk onboarding",
    reminder: "⏰ Status: complete",
    shareTitle: "Candidate link",
    shareRow: "Active · until Jul 12 · 0/3 views",
    shareNote: "The candidate uploads only the requested documents through a secure link. The employer sees status without searching WhatsApp chats.",
    deadlinesTitle: "Missing or expiring items",
    deadlines: [
      { t: "Training certificate — Maya", d: "missing" },
      { t: "Contract — Budi", d: "needs signature" },
      { t: "KTP — Ayu", d: "complete" },
    ],
  ...
  id: {
    metaTitle: "Demo — alur checklist dokumen kandidat",
    metaDesc:
      "Lihat produk tanpa mendaftar: checklist perusahaan, tautan unggah kandidat, status dokumen, dan berbagi aman.",
    back: "← Beranda",
    badge: "Demo",
    title: "Lihat ke dalam — tanpa daftar",
    sub: "Ini contoh dengan data fiktif. Di ruang kerja sungguhan, hanya pihak berwenang dan penerima tautan yang melihat dokumen.",
    familyTitle: "Kandidat",
    members: [
      { name: "Ayu", rel: "kandidat", docs: 7 },
      { name: "Budi", rel: "karyawan baru", docs: 5 },
      { name: "Maya", rel: "kandidat", docs: 4 },
    ],
    docsTitle: "Dokumen per checklist",
    docsSub: "Semua tertata per posisi dan jenis dokumen — lihat apa yang lengkap dan apa yang kurang.",
    docCardOwner: "Ayu",
    docCardTitle: "KTP / dokumen identitas",
    docCardType: "Dokumen kandidat",
    valid: "Diunggah untuk onboarding front desk",
    reminder: "⏰ Status: lengkap",
    shareTitle: "Tautan kandidat",
    shareRow: "Aktif · sampai 12 Jul · 0/3 tampilan",
    shareNote: "Kandidat hanya mengunggah dokumen yang diminta lewat tautan aman. Perusahaan melihat status tanpa mencari file di WhatsApp.",
    deadlinesTitle: "Dokumen kurang atau perlu diperbarui",
    deadlines: [
      { t: "Sertifikat training — Maya", d: "belum ada" },
      { t: "Kontrak — Budi", d: "perlu tanda tangan" },
      { t: "KTP — Ayu", d: "lengkap" },
    ],
