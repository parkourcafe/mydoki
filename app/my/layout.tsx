...
const M = {
  ru: {
    ...
    overview: "Обзор",
    passport: "Профессиональный профиль",
  ...
  const nav = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/my/passport", emoji: "🪪", label: t.passport },
        { href: "/my/opportunities", emoji: "✉️", label: t.opportunities },
